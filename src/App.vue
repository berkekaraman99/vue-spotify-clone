...
<template>
  <div>
    ...
    <div id="SideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
      ...
      <ul>
        <li class="font-semibold text-[18px] mt-3 text-gray-300 hover:text-white">My Playlist #1</li>
        <li class="font-semibold text-[18px] mt-3 text-gray-300 hover:text-white">My Playlist #2</li>
        <li class="font-semibold text-[18px] mt-3 text-gray-300 hover:text-white">My Playlist #3</li>
        <li class="font-semibold text-[18px] mt-3 text-gray-300 hover:text-white">My Playlist #4</li>
      </ul>
    </div>
  </div>
